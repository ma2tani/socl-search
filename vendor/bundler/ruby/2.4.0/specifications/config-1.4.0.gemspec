...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<bundler>.freeze, [">= 1.13.1", "~> 1.13"])
      s.add_development_dependency(%q<rake>.freeze, [">= 11.2.2", "~> 11.2"])
      s.add_development_dependency(%q<appraisal>.freeze, [">= 2.1.0", "~> 2.1"])
      s.add_development_dependency(%q<rails>.freeze, [">= 5.0.0.1", "~> 5.0"])
      ...
      s.add_dependency(%q<rubocop>.freeze, [">= 0.42.0", "~> 0.42"])
    end
  else
    s.add_dependency(%q<activesupport>.freeze, [">= 3.0"])
    s.add_dependency(%q<deep_merge>.freeze, ["~> 1.1.1"])
